...
<body>
    ...
    <?php if ($accessDenied): ?>
        <h1>Oops, it looks like you got lost!</h1>
    <?php else: ?>
        ...
        <div class="flex flex-wrap gap-3 justify-center">
            <?php foreach ($filteredCars as $car): ?>
                <div class="card card-compact bg-base-100 hover:bg-blue-60 w-72 shadow-xl relative">
                    <figure class="relative">
                        ...
                        <div class="absolute top-2 left-2 text-white px-2 py-1 text-sm rounded">
                            <a href="edit.php?carId=<?= $car['id'] ?>" class="btn btn-primary bg-green-500">
                                <i class="fa-solid fa-pen-to-square"></i> <!-- Edit -->
                            </a>
                        </div>
                        <div class="absolute top-2 right-2 text-white px-2 py-1 text-sm rounded">
                            <a href="delete_query.php?carId=<?= $car['id'] ?>" class="btn btn-primary bg-red-500">
            ...
            <?php endforeach; ?>
            <div class="flex w-72 flex-col gap-4 relative">
                <div class="absolute top-2 right-2 text-white px-2 py-1 text-sm rounded">
                    <a href="edit.php?carId=new" class="btn btn-primary bg-yellow-500">
                        Add new
                    </a>
                </div>
